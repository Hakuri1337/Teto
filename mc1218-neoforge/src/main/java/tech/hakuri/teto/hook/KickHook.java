...
public class KickHook {
    ...
    static class MV extends MethodVisitor {
        ...
        public void visitCode() {
            ...
            mv.visitMethodInsn(Opcodes.INVOKESTATIC, Type.getInternalName(EventKick.class), ReflectBridge.firstMethodName(EventKick.class), Type.getMethodDescriptor(Type.BOOLEAN_TYPE, Type.getType(Object.class)), false);
