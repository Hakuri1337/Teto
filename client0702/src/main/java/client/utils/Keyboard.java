...
public class Keyboard {
    ...
    public static Map<String, Integer> keyCode = new HashMap<>();
    public static Map<Integer, String> keyName = new HashMap<>();
    ...
    public static String get(int keyCode) {
        String result = keyName.get(keyCode);
        if (result == null) {
            return "无";
        }
        return result;
    ...
    public static int get(String keyName) {
        Integer result = Keyboard.keyCode.get(keyName);
        if (result == null) {
            return 0;
        }
        return result;
