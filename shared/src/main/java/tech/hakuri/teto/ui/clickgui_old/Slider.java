...
public class Slider extends ScreenLike {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        Platform.renderer().rect(x, y, x + renderWidth, y + height, bgColor(mouseX, mouseY));

        Platform.renderer().textShadow(FontSize.S, String.format("    %s：%.2f", tech.hakuri.teto.i18n.I18n.value(value.name), value.numberValue), x, y, textColor(mouseX, mouseY));
