...
public class ModuleButton extends ScreenLike {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        String str = module.keyCode == 0 ? module.displayName() : String.format("%s [ %s ] ", module.displayName(), Keyboard.get(module.keyCode));
        Platform.renderer().textShadow(FontSize.S, str, x, y, textColor(mouseX, mouseY));
