...
public class RotationUtils {
    ...
    public static double fovCalc(Entity from, Entity to) {
        ...
        Vec3 fromDirection = from.getViewVector(Timing.partialTick()).normalize();
    ...
    public static double distanceToEntityAABBNearest(Entity from, Entity to) {
        Minecraft mc = Minecraft.getInstance();
        return from.getEyePosition(Timing.partialTick()).distanceTo(aabbNearest(from.getEyePosition(Timing.partialTick()), to.getBoundingBox()));
    }
