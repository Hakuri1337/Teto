...
public class InGameClickGUI extends Module {
    ...
    /** 新旧两套 ClickGUI：默认 Material 新界面，可切回旧版。 */
    public static Value mode = new Value("菜单样式", "Material", java.util.List.of("Material", "Old"));
    ...
    /** 按当前样式返回对应界面。Old 的类只在旧路径里才加载，避免新界面依赖旧实现。 */
