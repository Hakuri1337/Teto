...
import tech.hakuri.teto.compat.MoveInput;
...
public class RotationManager extends Module {
    ...
    public void onMoveInput(EventMoveInput event) {
        ...
        float originForward = MoveInput.forward(event.keyboardInput);
        float originLeft = MoveInput.left(event.keyboardInput);
        ...
        MoveInput.set(event.keyboardInput, calcForward, calcLeft);
    }
